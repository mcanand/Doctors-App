odoo.define('web_app_front.doctor_information_pick', function (require) {
    'use strict';
    ...
    publicWidget.registry.doctor_information_pick = publicWidget.Widget.extend({
        selector: '.information-container',
        events: {
            'click .doctor-info-data': '_onClickDoctorBox',
